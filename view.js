class View {
    ...
    Play = {
        render: (moves) => {
            ...
            You will lose your current record.</p>
    ...
    Rules = {
        render: () => {
            ...
            <div>Try to place boxes on green targets in a minimum amount of moves. Your points depend on the 
            amount of moves you have taken. If you play level second or more times, you will receive fewer 
            points.</div>
    ...
    Score = {
        render: () => {
            ...
            <div class="records" id="records">
               ...
               <input type="email" class="input" id="delDataEmail" placeholder="Email" />
    ...
    drawField(direction, map) {
        const cellSize = 70;// size of the cell
